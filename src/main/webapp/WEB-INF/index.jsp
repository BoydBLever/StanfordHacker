	...
	<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<a class="logout-centered" href="/logout">Logout</a>
							...
							<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img class="d-block w-100" src="/img/garage.jpeg" alt="First photo" height="672"
											width="100%">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="/img/stanfordhacker_main.jpeg"
											alt="Second photo" height="672" width="100%">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="/img/bedroom.jpeg" alt="Third photo"
											height="672" width="100%">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="/img/bedroom2.jpeg" alt="Fourth photo"
											height="672" width="100%">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="/img/kitchen.jpeg" alt="Fifth photo"
											height="672" width="100%">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="/img/bathroom.jpeg" alt="Sixth photo"
											height="672" width="100%">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="/img/bathroom2.jpeg" alt="Seventh photo"
											height="672" width="100%">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="/img/bedwithpillow.jpeg" alt="Eighth photo"
											height="672" width="100%">
									</div>
								</div>
							...
							<div style="border: 5px solid #3374FF" class="welcome">
								...
								<div class="right">
									...
									<p class="welcome-message"> It’s me, Boyd Lever, King of Accommodation in Silicon
										Valley!
										We have a huge problem here. The cost of housing has skyrocketed. And it is only
										going to get worse.
										I have a solution that works. It works for many people, month after month.
										And they keep coming back. I’m making revenue. I have a nice website, and I’m
										seeking investment to take everything to the next level.
										I’m confident that I’m the right person to do the job, I have domain expertise,
										and I’m also a full-stack software engineer, so I can build the backend.
										If you are a traveler looking for inexpensive accommodations with an amazing
										host in a perfect location by Stanford University in Palo Alto, California, make
										a reservation by email (boydlever@stanfordhacker.com) or
										book and pay for your bed with the form below, and discover what so many other
										guests love about the one and only Stanford Hacker House. I promise to offer the
										highest quality shared room in Silicon Valley at the lowest possible price.
										So whether you are a hacker, engineer, designer, startup founder, investor, tech
										enthusiast, college student, graduate student or a curious traveler, I look
										forward to welcoming you to my garage. You will enjoy having me as your
										superhost.
									</p>
								</div>
							</div>
								...
								<div class="guest-reviews">
									...
									<div class="box1">
										<div class="guest-card">
											<img src="/img/Pranav.jpeg" alt="Picture of Pranav" width="450"
												height="300">
										</div>
										<div class="guest-card">
											<img src="/img/Mitchell.jpeg" alt="Picture of Mitchell" width="450"
												height="270">
										</div>
									</div>
									<div class="box2">
							...
							<div style="border: 5px solid #3374FF" class="accommodations-amenities">
								...
								<div class="right-container">
									...
									<img src="/img/bathroom2.jpeg" alt="photo of toilet & sink" width="150"
										height="150">
		...
		The guest clicks the Book Now button, which redirects to localhost 3000 where the payment form is located. -->
							<div style="border: 5px solid #B8DAFF" class="reserve">
								...
								<form oninput="price.value = quantity.valueAsNumber * 32"
									...
									<br>
									<input style="background-color: #28A745; color: white" type="submit"
										value="Reserve your bed now!">
								</form>
							</div>
						</div>
					</body>
